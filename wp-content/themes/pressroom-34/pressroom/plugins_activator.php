...
add_action('tgmpa_register', 'pr_theme_register_required_plugins');
function pr_theme_register_required_plugins() 
{
	$plugins = array(
		array(
			'name'     				=> __("Theme Dummy Content Importer", 'pressroom'), // The plugin name
		...
		array(
			'name'     				=> __("Pressroom Theme Shortcodes", 'pressroom'), // The plugin name
			'slug'     				=> 'pressroom_shortcodes', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/pressroom_shortcodes.zip', // The plugin source
		...
		array(
			'name'     				=> __("WPBakery Visual Composer", 'pressroom'), // The plugin name
	 ...
	 */
	$config = array(
		'domain'       		=> 'pressroom',         	// Text domain - likely want to be the same as your theme.
		...
		'strings'      		=> array(
			...
			'installing'                       			=> __( 'Installing Plugin: %s', 'pressroom' ), // %1$s = plugin name
			'oops'                             			=> __( 'Something went wrong with the plugin API.', 'pressroom' ),
			'notice_can_install_required'     			=> _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'pressroom' ), // %1$s = plugin name(s)
			'notice_can_install_recommended'			=> _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'pressroom' ), // %1$s = plugin name(s)
			...
			'notice_ask_to_update' 						=> _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s. Please check update instructions <a href="http://support.quanticalabs.com/forum/topic/13877/faq-frequently-asked-questions#question_9">here</a>.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s. Please check update instructions <a href="http://support.quanticalabs.com/forum/topic/13877/faq-frequently-asked-questions#question_9">here</a>.', 'pressroom' ), // %1$s = plugin name(s)
			...
			'activate_link' 				  			=> _n_noop( 'Activate installed plugin', 'Activate installed plugins', 'pressroom' ),
			'return'                           			=> __( 'Return to Required Plugins Installer', 'pressroom' ),
			'plugin_activated'                 			=> __( 'Plugin activated successfully.', 'pressroom' ),
			'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'pressroom' ), // %1$s = dashboard link
