 ...
 */
	class UniteSettingsUC{
		...
		public function addControl($control_item_name,$controlled_item_name,$control_type,$value){
			...
			UniteFunctionsUC::validateNotEmpty($value,"control value");
		...
		private function a________________XML____________(){}
		...
		public function loadXMLFile($filepath){
			...
			foreach($fieldsets as $fieldset){
				...
				if(!empty($loadFrom)){
					$this->addExternalSettings($loadFrom);
					continue;
				}
		 ...
		 */
		private function addExternalSettings($filename){
