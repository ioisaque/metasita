...
defined('_JEXEC') or die('Restricted access');
	...
	class UniteSettingsAdvancedUC extends UniteSettingsUC{
		...
		public function updateSelectToAlignHor($name, $default = null){
			...
			$arrItems = array(
					"left"=>__("Left",ADDONLIBRARY_TEXTDOMAIN),
					"center"=>__("Center", ADDONLIBRARY_TEXTDOMAIN),
					"right"=>__("Right", ADDONLIBRARY_TEXTDOMAIN)
			);
		...
		public function updateSelectToAlignVert($name, $default = null){
			...
			$arrItems = array(
					"top"=>__("Top",ADDONLIBRARY_TEXTDOMAIN),
					"middle"=>__("Middle", ADDONLIBRARY_TEXTDOMAIN),
					"bottom"=>__("Bottom", ADDONLIBRARY_TEXTDOMAIN)
			);
		...
		private function a______CONTNET_SELECTOR_____(){}
			...
			foreach($arrOptions as $text=>$option){
				...
				switch($option){
					case "custom":
						...
						$this->addTextBox($name."_title", "", __("&nbsp;Title",ADDONLIBRARY_TEXTDOMAIN), $params);
						
						$params = array(
								UniteSettingsUC::PARAM_CLASSADD=>"unite-content-intro");
						
						$this->addTextArea($name."_intro", "", __("&nbsp;Custom Intro",ADDONLIBRARY_TEXTDOMAIN), $params);
						*/
						...
						$this->addEditor($name."_content", $value, __("&nbsp;Custom Content",ADDONLIBRARY_TEXTDOMAIN), $params);
						
						/*
						$params = array(
								UniteSettingsUC::PARAM_CLASSADD=>"unite-content-link");
						
						$this->addTextBox($name."_link", "", __("&nbsp;Link",ADDONLIBRARY_TEXTDOMAIN), $params);
						*/
